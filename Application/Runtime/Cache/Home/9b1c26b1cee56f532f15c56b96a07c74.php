...
<div class="header">
    ...
    <div class="subtop">
        <div class="w1000 clearfix">
            ...
            <div class="bignav pull-right"><ul><li><a href="<?php echo U('Index/product');?>">产品介绍</a></li><li><a href="<?php echo U('Index/feedback');?>">问题与需求</a></li><li><a href="<?php echo U('Manage/Login/index');?>" target="_blank">Alpha体验中心</a></li></ul></div>
        </div>
    </div>
</div>
